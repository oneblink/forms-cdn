...
- update [@oneblink/apps-react](https://www.npmjs.com/package/@oneblink/apps-react) to [0.4.4-beta.4](https://github.com/oneblink/apps-react/blob/master/CHANGELOG.md) (from [0.4.1-beta.20](https://github.com/oneblink/apps-react/releases/tag/v0.4.0))
