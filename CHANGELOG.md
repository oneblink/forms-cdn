...
- update [@oneblink/apps-react](https://www.npmjs.com/package/@oneblink/apps-react) to [0.2.1-beta.4](https://github.com/oneblink/apps-react/blob/master/CHANGELOG.md) (from [0.2.0-beta.5](https://github.com/oneblink/apps-react/blob/master/CHANGELOG.md))
